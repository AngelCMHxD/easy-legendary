...
module.exports = async () => {
	...
	const confirmCorrupted = await inquirer.prompt([
		{
			type: "confirm",
			name: "confirm",
	...
	if (confirmCorrupted) await cp.execSync("legendary clean-saves -y", { stdio: "pipe" }) // This DOESN'T delete your saves, only your corrupted ones
